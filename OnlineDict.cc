...
QNetworkAccessManager *OnlineDict::networkManager(){
   if(!manager) manager = new QNetworkAccessManager;
   return manager;
}

list<dictElementParser *>::iterator OnlineDict::getMatchIterator(){
...
list<TDictEntry *> OnlineDict::getAll(){
   list<TDictEntry *> lst;
...
QNetworkAccessManager *OnlineDict::manager=NULL ;
